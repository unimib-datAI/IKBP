...
export const DocumentController = {
  ...
  findOne: async (id) => {
    ...
    let mappenAnnotationSets = {};
    annotationSetsWithAnnotations.forEach((annotationSet) => {
      mappenAnnotationSets[annotationSet.name] = annotationSet;
    });
    return {
      ...doc,
      annotation_sets: mappenAnnotationSets,
    };
  },
